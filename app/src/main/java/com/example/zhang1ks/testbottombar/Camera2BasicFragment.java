...
//    private ImageView otherCamera;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.posting_page_plus, container, false);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        frameLayout=(FrameLayout) view.findViewById(R.id.imageviewframe);
        imageView = (ImageView) view.findViewById(R.id.imageontexture);
    ...
    //Switch to VideoMode from PhotoMode
    private void switchVideo(){
        Camera2VideoFragment nextFrag= new Camera2VideoFragment().newInstance();
