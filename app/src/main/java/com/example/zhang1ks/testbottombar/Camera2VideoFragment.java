...
//            }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mSwitchCamera = (ImageView) view.findViewById(R.id.switch_camera);
        mSwitchCamera.setOnClickListener(this);

        btn_post = (Button) view.findViewById(R.id.btn_post);
        btn_post.setOnClickListener(this);

        frameLayout=(FrameLayout) view.findViewById(R.id.videoviewframe);
        videoView = (VideoView) view.findViewById(R.id.videoontexture);
...
//        view.findViewById(R.id.info).setOnClickListener(this);
    ...
    private void postResource(){
        //Post the video here to save in Database for further use on Home Page
        final DBHelper mydb = new DBHelper(getActivity());
        btn_post.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                mydb.insertSavedResource(savedVideo);
                Log.e(TAG, "Inserted");
            }
        });
    }
    ...
    private void switchPhoto(){
        ...
        this.getFragmentManager().beginTransaction()
                .replace(R.id.myFramelayout, nextFrag,TAG)
                .addToBackStack(null)
                .commit();
    ...
    private void startRecordingVideo() {
        ...
        mMediaRecorder.setOnInfoListener(new MediaRecorder.OnInfoListener() {
            @Override public void onInfo(MediaRecorder mr, int what, int extra) {
                if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) { stopRecordingVideo(); } } });
    }
